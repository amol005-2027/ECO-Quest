...
import { Camera, Upload, CheckCircle, Clock, X, MessageSquare, Heart, Share2, TreePine, Recycle, Droplets, Zap } from 'lucide-react';
...
const PeerValidation = () => {
  const [activeTab, setActiveTab] = useState<'submit' | 'pending' | 'verified'>('submit');
  ...
  const ecoActions: EcoAction[] = [
    {
      ...
      category: 'trees',
      description: 'Organized a tree planting drive with my friends during lunch break. We planted neem, mango, and gulmohar saplings in the empty area behind our school.',
    ...
    },
    {
      ...
      category: 'recycling',
      description: 'Spent my weekend collecting plastic bottles and bags from my neighborhood. Took everything to the local recycling center.',
    ...
    },
    {
      ...
      category: 'water',
      description: 'Noticed a leaking tap in our school washroom that was wasting lots of water. Reported to maintenance and helped fix it.',
    ...
    },
    {
      ...
      category: 'energy',
      description: 'Convinced my parents to replace all old bulbs with LED ones. This will save electricity and reduce our carbon footprint.',
  ...
  const handleSubmit = () => {
    ...
    toast({
      ...
      description: "Your eco-action has been submitted for peer verification. You'll earn points once verified!",
    });
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gradient-eco mb-2">Peer Validation</h2>
        ...
        <Card className="card-eco">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground text-sm">
              Upload proof of your environmental action to earn eco-points and inspire others
            </p>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="border-2 border-dashed border-border rounded-lg p-8 text-center hover:border-primary/50 transition-colors cursor-pointer">
                ...
                <p className="text-xs text-muted-foreground">
                  Show your action in progress or the result. Max file size: 10MB
                </p>
              </div>
            </div>

            <div className="bg-gradient-to-r from-primary/10 to-primary-glow/10 p-4 rounded-xl">
              <h4 className="font-semibold mb-2 text-primary">💡 Tips for Better Verification</h4>
        ...
        <div className="space-y-4">
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">
              Actions are typically verified within 24-48 hours by peers or teachers
            </p>
          </div>
          
          {ecoActions
            .filter(action => action.status === 'pending' && action.studentName.includes('You'))
            .map((action) => (
      ...
      {activeTab === 'verified' && (
        <div className="space-y-4">
          <div className="text-center mb-6">
            <h3 className="text-xl font-semibold text-gradient-eco mb-2">Community Eco Actions</h3>
            <p className="text-muted-foreground">
              Real actions by real students making a difference!
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <Avatar className="h-10 w-10">
                    <AvatarFallback>
                      {action.studentName.split(' ').map(n => n[0]).join('')}
                    </AvatarFallback>
                  </Avatar>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <h4 className="font-semibold">{action.studentName}</h4>
                    ...
                    {action.imageUrl && (
                      <div className="bg-muted rounded-lg p-8 text-center mb-3">
                        <Camera className="h-12 w-12 text-muted-foreground mx-auto mb-2" />
                        <p className="text-sm text-muted-foreground">Photo/Video Evidence</p>
                      </div>
                    )}
                  </div>
                </div>
