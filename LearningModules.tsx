    ...
    <div className="space-y-6">
      ...
      {!currentLesson && activeTab === "modules" && (
        <div className="space-y-6">
          ...
          {/* Navigation Tabs - now horizontally scrollable on mobile */}
          <div className="flex justify-center">
            <div className="flex gap-2 bg-card/50 p-2 rounded-2xl backdrop-blur-sm max-w-full overflow-x-auto no-scrollbar snap-x snap-mandatory">
              <Button
                variant={activeTab === "modules" ? "default" : "ghost"}
                className={`flex items-center gap-2 rounded-xl transition-all duration-200 snap-start whitespace-nowrap ${
                  activeTab === "modules"
